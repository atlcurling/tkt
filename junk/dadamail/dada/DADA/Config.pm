...
$HELP_LINKS_URL ||= 'http://dadamailproject.com/pro_dada/5.2.0';
...
Path to the admin template. The default admin template is located at: 
 ...
 dada/DADA/Template/templates/admin_template.tmpl
...
$SUBSCRIPTION_NOTICE_MESSAGE_SUBJECT   ||= 'Subscribed <!-- tmpl_var subscriber.email -->';  
...
$PROFILE_EMAIL_UPDATED_NOTIFICATION_MESSAGE_SUBJECT ||= 'Profile Email Update Notification, From: <!-- tmpl_var profile.prev_email -->, To: <!-- tmpl_var profile.email -->'; 
