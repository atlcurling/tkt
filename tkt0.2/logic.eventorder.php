<?php
	...
	$eventStatusPage = "eventstatus.php";
	...
	/* *************************************************************************************************************************** */
		...
		case 'Submit Order':
			...
			echo "<h2>Confirm Order -$usernm - $memstatus</h2>\n";
			echo "<br/>\n";
	...
	/* *************************************************************************************************************************** */
		...
		/* Create the order in the orderhdr and orderdtl tables */
			...
			$memstatus = ($user->member ? "Member" : "Non-Member");
			echo "<h2>Order Placed - $usernm - $memstatus</h2>\n";
		...
		/* Send to PayPal for purchases */
			...
			/* PayPal form */
				...
				echo "<p><center>Click <strong>Buy Now</strong> below to go to PayPal to complete your purchase.</center></p>\n";
				...
				echo "<input type='hidden' name='return' value='{$BASEURL}{$prevPage}?action=ppapprove'>\n";
				echo "<input type='hidden' name='cancel_return' value='{$BASEURL}{$prevPage}?action=ppreject'>\n";
				...
				echo "<form action='$eventStatusPage' method='post'>\n";
