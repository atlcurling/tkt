  ...
  <div class="colleft">
    <div class="col1"> 
	  <!-- InstanceBeginEditable name="body" -->
	    ...
	    <h1>Atlanta Curling Club: Leagues</h1>
<!--
	  <iframe width='780' height='600' frameborder='0' src='https://docs.google.com/spreadsheet/ccc?key=0AuWV0jAgCGbzdHBBeml2alFIR2tRMVpxZkpNenFwT0E&output=html&widget=true'></iframe>
	  <iframe width='780' height='600' frameborder='0' src='https://docs.google.com/spreadsheet/ccc?key=0AuWV0jAgCGbzdDVKMnMzdjVpOVY2RkNfaml1TUQ1dGc&output=html&widget=true'></iframe>
-->
	  <iframe width='780' height='600' frameborder='0' src='https://docs.google.com/spreadsheet/ccc?key=0AuWV0jAgCGbzdHBBdlltR29qSkRlMVVaRUkyTVdQYnc&output=html&widget=true'></iframe>
	  <!-- InstanceEndEditable -->
	</div><!-- col1 -->
    <div class="col2">
	  <center>
