...
<?php loginprompt(); ?>
		...
		<h1>Atlanta Curling Club: Media</h1>
		<p>
		<h2>PBA 30 "This is Atlanta" profile of Atlanta Curling Club</h2>								
		<iframe width="640" height="360" src="http://www.youtube.com/embed/zMqHvso8waE?rel=0" frameborder="0" allowfullscreen></iframe>
		</p>
		<p>
		<h2>Video of Jeff's first curling point from our 2010 Curling Camp</h2>
		<iframe width="640" height="360" src="http://www.youtube.com/embed/RBq8r23-e5A?rel=0" frameborder="0" allowfullscreen></iframe>
		</p>
	  <!-- InstanceEndEditable -->
	</div><!-- col1 -->
    <div class="col2">
