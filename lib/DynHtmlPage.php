...
<?php
	...
	public static function menu ($istop) {
		...
		$m = array(
			...
			array("Donate", 		"donate.php",			0),
			array("Dedicated Ice",	"http://atlantadedicatedice.com", 0),
	...
	public static function upcoming() {
		...
		while ($row = mysql_fetch_object($result)) {
			...
			if (! $row->eventgrouped || ($row->eventgrouped && $preveventcdpfx != $eventcdpfx)) {
				...
				echo "    <div id='event-title'><a href='$url'>$row->eventnm</a></div>\n";
...
<?php
	...
	public function enableHdrDiv() {$this->hdrDivEnabled = 1;}
	public function disableHdrDiv() {$this->hdrDivEnabled = 0;}
