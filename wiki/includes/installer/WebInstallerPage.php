...
$this->addHtml( '<input type="checkbox" id="confirmConfig" name="confirmConfig"><label for="confirmConfig">Select to complete installation with configuration file.</label>' );
...
class WebInstaller_Complete extends WebInstallerPage {
	...
	public function execute() {
		if(isset($_GET['confirmConfig'])) {
$this->addHTML('Your installation has completed. LocalSettings.php has been placed in your Wikis parent directory. You may now go to your installation.');
} else {
