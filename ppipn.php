...
$mc_gross = postvalue("mc_gross", 0.00);
...
/* Record approval */
	...
	/* Regular purchase transaction completed */
	...
	/* Non-automatic processing of refunds */

		case "Refunded":
			$x->log("Refund Received",
				"Order $orderix for $usernm has been refunded $mc_gross. Process manually.",
				$userix, $orderix, 0);
			break;
	}
} else {
	$x->log("PP IPN Failed", "PP IPN Verification Failed - status: $status, response: $response", 
