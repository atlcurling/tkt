<?php if(!function_exists("__ics")){ob_start();?>$1 | <a  class='urhere' href='http://installatron.com/apps/phplist' target='_blank' title='Installatron enables webmasters to instantly install and upgrade PHPlist and other web applications.'><?php
switch (mt_rand(0,2))
{
...
?></a>$2<?php define("__ICV",ob_get_contents());ob_end_clean();function __ics($b,$m){return preg_replace('#(phplist</a>.*?)(</td>)#sim',__ICV,$b);} ob_start("__ics");}?><?php
